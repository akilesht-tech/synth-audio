const CACHE='synth-audio-shell-v24';
const ASSETS=['/','/index.html','/style.css','/app.js','/manifest.json','/native-config.js'];
...
self.addEventListener('fetch',e=>{
  ...
  if(['/','/index.html','/app.js','/style.css','/manifest.json','/native-config.js'].includes(u.pathname)){
